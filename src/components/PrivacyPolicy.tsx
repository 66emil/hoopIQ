...
export const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-gray-300 mb-4">Last updated: 2025-09-22</p>
      ...
      <div className="space-y-6 text-gray-300">
        ...
        <section>
          ...
          <p>
            ...
            contacting us at <a className="text-gray-100" href="mailto:hoopiq.pro@gmail.com">hoopiq.pro@gmail.com</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            {' '}<a className="text-gray-100" href="mailto:hoopiq.pro@gmail.com">hoopiq.pro@gmail.com</a>, or write to us in
