...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-12 border-t border-gray-800 bg-gray-900/80 backdrop-blur supports-[backdrop-filter]:bg-gray-900/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          ...
          <div className="flex items-start gap-4">
            <div className="shrink-0">
              <img
                src={logoSrc}
                alt="Company logo"
                className="h-12 w-12 rounded-md ring-1 ring-gray-700 object-cover"
                onError={(e) => {
                  // Фолбэк: показываем простой SVG, если логотип не найден
            ...
            <p className="text-sm leading-6 text-gray-300 max-w-xl">
          ...
          <nav className="flex items-center gap-6">
            <a href="/support" className="text-sm text-gray-300 hover:text-white">
              Support
            </a>
        ...
        <div className="mt-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="text-sm text-gray-400">
            ...
            <a href="mailto:hoopiq.pro@gmail.com" className="text-gray-2 00 hover:text-white">
