        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-white">{t('tactics.title')}</h1>
            </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700">
            <h2 className="text-2xl font-bold mb-4 text-orange-400">{t('tactics.progress.title')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-400">{completedTactics}</div>
                <div className="text-gray-400">{t('tactics.progress.completed')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-400">{tactics.length}</div>
                <div className="text-gray-400">{t('tactics.progress.total')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400">{progress.level}</div>
                <div className="text-gray-400">{t('tactics.progress.level')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-400">{progress.totalScore}</div>
          ...
          {/* Info Box */}
          <div className="bg-blue-500/20 backdrop-blur-sm rounded-xl p-6 mb-8 border border-blue-600">
